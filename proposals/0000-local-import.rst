...
We propose to relaxe the syntax for import to authorise `import` statement inside a `where` / `let` clause. The imported symboles will only be visible from local scope.
